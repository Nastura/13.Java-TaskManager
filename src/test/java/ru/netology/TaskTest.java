...
class TaskTest {
    ...
    public void testTrueOrFalseSimpleTask() {
        SimpleTask simpleTask = new SimpleTask(5, "Написать маме");

        Assertions.assertTrue(simpleTask.matches("Написать")); // проверка существующейго слова
        Assertions.assertTrue(simpleTask.matches("Написать маме")); // проверка существующего словосочетания
        Assertions.assertFalse(simpleTask.matches("написать")); // проверка регистра
        Assertions.assertFalse(simpleTask.matches("начальнику")); //проверка несуществующей строки
    }
    ...
    public void testTrueOrFalseEpic() {
        ...
        Assertions.assertFalse(epic.matches("Банан")); // проверка поиска отсутствующего слова
